...
document.addEventListener("DOMContentLoaded", function () {
    var timerID;
    timerID = window.setInterval("f_showclock()", 1000);               
    console.log("DOM is ready!");
});

function f_showclock() {
    var now = new Date();      //javascript
    var h = now.getHours();
    ...
    m = m < 10 ? '0' + m : m;
    a = a < 10 ? '0' + a : a;
    // txtClock.value=h+':'+m+':'+a;
    window.document.getElementById("txtClock").value = h + ':' + m + ':' + a;
}